          ...
          <ul className="row grid justify-content-center">
            ...
            >
              <figure onClick={toggleModalOne}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">ConnectMD Project</span>
                </div>
              </figure>
            ...
            >
              <figure onClick={toggleModalTwo}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Portfilio Project</span>
                </div>
              </figure>
            ...
            >
              <figure onClick={toggleModalThree}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">NextonHub App Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Data Visualization</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Deep Learning Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">AI Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Cloud Services</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Health Care Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">TMS Projact</span>
                </div>
              </figure>
