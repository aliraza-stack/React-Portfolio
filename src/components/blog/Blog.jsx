    ...
    <>
        ...
        <article className="post-container" onClick={toggleModalOne}>
          ...
          <div className="post-content">
            ...
            <div className="entry-content open-sans-font">
              <p>
                How to build a digital twin that can be used to monitor and control a 
                virtual objects or system that spans its lifecycle, it is updated 
                from real-time data, and uses simulation.
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalTwo}>
          ...
          <div className="post-content">
            ...
            <div className="entry-content open-sans-font">
              <p>
                The top 10 toolkits for deep learning in the future, and the best way to learn them. 
                Complete list of the top 10 toolkits for DL.
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalThree}>
          ...
          <div className="post-content">
            ...
            <div className="entry-content open-sans-font">
              <p>
                Web accessibility is a topic that is constantly changing. But major changes are rare in web accessibility.
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalFour}>
          ...
          <div className="post-content">
            ...
            <div className="entry-content open-sans-font">
              <p>
                Augmented reality is a technology that allows users to experience a real world object in a virtual world.
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalFive}>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Avalution in Deap Learning</h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
                Deep learning is a powerful tool for building machine learning models. But it is not always the best tool for building models. 
              </p>
            </div>
          </div>
          {/* End .post-content */}
      ...
      <div className="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
        <article className="post-container" onClick={toggleModalSix}>
          ...
          <div className="post-content">
            <div className="entry-header">
              <h3>Experiences of IT World</h3>
            </div>
            <div className="entry-content open-sans-font">
              <p>
                My Personal Experience in IT World. I have worked in different companies and have worked in different fields.
              </p> 
            </div>
          </div>
          {/* End .post-content */}
